...
class RegistryState
{
    ...
    _getChildren(dn)
    {
        ...
        var childDns = this._getChildDns(dn);
        for(var childDn of childDns) {
            var childNode = this._constructNode(childDn);
            if (childNode) {
    ...
    _buildTreeNode(parentDn)
    {
        ...
        var childrenDns = this._getChildDns(parentDn);
    ...
    buildBundle()
    {
        ...
        {
            bundle.nodes.push(
                this._buildBundleItem(dn, this._nodeMap[dn])
            );

            bundle.children.push(
                this._buildBundleItem(dn, this._getChildDns(dn))
            );
